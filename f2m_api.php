...
/* Subject line */
$subject = "Contact from razifalah.com";

/* Site URL */
$site_url = "http://www.razifalah.com";

/* Site Name */
$site_name = "RAZIFALAH.COM";
...
<head>
	<meta charset="utf-8">
	<meta http-equiv="refresh" content="15;url=<?php print $site_url; ?>">
	<title>Email was not successfully sent! <?php print $site_name; ?></title>
	<style>
...
var downloadTimer = setInterval(function(){
  if(timeleftb <= 0){
    ...
    document.getElementById("countdown").innerHTML = timeleftb + " seconds remaining";
  }
  timeleftb -= 1;
}, 1000);
	...
	<div id="thankyou">
		<p><strong>There was a problem at our end, Email was not sent successfully.</strong></p>
		<p>Please use other contact method.</p><p>Redirecting client...</p>
		<center><div id="countdown"></div><progress value="0" max="15" id="progressBar"></progress></center>
		<p>If you're not redirected in 15 seconds, then <a href="<?php print $continue; ?>">click here to go to the homepage.</a></p>
	</div>
</body>
</html>